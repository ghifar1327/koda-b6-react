...
export default function Header() {
  ...
  return (
     user.role === "admin" ?
      <nav 
      className={`w-full z-1000 h-auto left-0 top-0  flex justify-between px-[5%] lg:px-[10%] p-3`}
      >
      </nav>
      :
      <nav
          ...
          {user ? (
            <div className="flex items-center gap-5">
              <section className="relative">
                ...
                <div
                  className={`absolute ${!toggle && "hidden"} w-70 p-2 shaddow flex flex-col gap-10 py-5 bg-white text-black rounded-lg right-0 mt-5`}
                >
