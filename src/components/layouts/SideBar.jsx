  ...
  export default function SideBar() {
    ...
    return (
      <aside className="w-[20%] border-r-2 border-gray-300 min-h-screen py-5 pr-5 flex flex-col gap-1">
        ...
        >
          <LayoutDashboard /> <p>Dasboard</p>
        </Link>
        <Link
          to="/admin/products"
          className={`${location.pathname == "/admin/products" ? "bg-primary text-black" : "text-gray-600"} p-2  flex gap-5 items-center text-xl rounded-xl`}
        >
          <Beaker /> <p>Product</p>
        </Link>
        <Link
